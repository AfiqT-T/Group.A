    ...
    <main class="main">
        ...
        <section id="specials" class="specials section">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($menu->vendor_id); ?></td>
                                <td><?php echo e($menu->vendor_name); ?></td>
                                ...
                                <td>
                                    <form method="POST" action="<?php echo e(route('cart.add')); ?>">
                                        ...
                                        <input type="hidden" name="menu_name" value="<?php echo e($menu->menu_name); ?>">
                                        <input type="hidden" name="vendor_id" value="<?php echo e($menu->vendor_id); ?>">
                                        <input type="hidden" name="vendor_name" value="<?php echo e($menu->vendor_name); ?>">
                                        <input type="hidden" name="price" value="<?php echo e($menu->price); ?>">
                                </td>
                                <td>
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('cart')); ?>" class="btn btn-cart">
                    Go to Cart
                </a>
            </div>
        </section>
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AliArabesque\resources\views/menu.blade.php ENDPATH**/ ?>